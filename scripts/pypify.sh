...
cp jobs/generic/sql_job.py yaetos/libs/generic_jobs/sql_job.py
...
cp tests/jobs/examples/ex1_frameworked_job_test.py yaetos/scripts/copy/ex1_frameworked_job_test.py
