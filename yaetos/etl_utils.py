...
LOCAL_APP_FOLDER = os.environ.get('PYSPARK_AWS_ETL_HOME', '') # PYSPARK_AWS_ETL_HOME set to end with '/', TODO: rename to YAETOS_HOME
LOCAL_APP_FOLDER_TMP = os.environ.get('DEF_PATH_TMP', '')  # TODO: integrate in LOCAL_APP_FOLDER or LOCAL_JOB_REPO_FOLDER when sure it doesn't break features.
