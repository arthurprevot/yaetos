...
sudo pip-3.6 install awscli==1.20.41 # depends on botocore from 1.12.57
...
sudo pip-3.6 install cryptography==3.4.8  # Necessary for simple-salesforce, to avoid simple-salesforce loading 3.4.4 causing pbs.
