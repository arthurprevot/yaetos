...
JOB_FOLDER = 'jobs/'
PACKAGES_LOCAL = 'com.amazonaws:aws-java-sdk-pom:1.11.760,org.apache.hadoop:hadoop-aws:2.7.0,com.databricks:spark-redshift_2.11:2.0.1,org.apache.spark:spark-avro_2.12:3.1.1,mysql:mysql-connector-java:8.0.22,org.postgresql:postgresql:42.2.18'  # necessary for reading/writing to S3, redshift, mysql & clickhouse using spark connector.
PACKAGES_EMR = 'com.databricks:spark-redshift_2.11:2.0.1,org.apache.spark:spark-avro_2.12:3.1.1,mysql:mysql-connector-java:8.0.22,org.postgresql:postgresql:42.2.18'  # necessary for reading/writing to redshift, mysql & clickhouse using spark connector.
